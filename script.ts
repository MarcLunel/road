...
class Road {
  ...
  public editPoints(coordinateX1:number, coordinateX2:number, coordinateY1:number, coordinateY2:number){
...
function move():void{
  ...
  let coordinateX1Road:number = Number(road0.getAttribute('x1'));
  let coordinateY1Road:number = Number(road0.getAttribute('y1'));
  let coordinateX2Road:number = Number(road0.getAttribute('x2'));
  let coordinateY2Road:number = Number(road0.getAttribute('y2'));
